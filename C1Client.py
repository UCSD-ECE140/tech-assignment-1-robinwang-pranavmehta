...
if __name__ == '__main__':
    ...
    client2 = paho.Client(paho.CallbackAPIVersion.VERSION1, client_id="Client2", userdata=None, protocol=paho.MQTTv5)
    ...
    client3 = paho.Client(paho.CallbackAPIVersion.VERSION1, client_id="Client3", userdata=None, protocol=paho.MQTTv5)
